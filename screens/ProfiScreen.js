...
const ProfiScreen = () => {
  ...
  return (
    <SafeAreaView className="h-full w-full  bg-black">
        <View className="flex-row mt-20 space-x-8">
          <View className="ml-5">
             <View className=" items-center ">
              <Image className="w-16 h-16 ml-5 mt-5" tintColor='#DC2626' source={loginImages.videoCamera}/>
             </View>
              <Image className="mt-20 ml-2 w-32 h-48 mb-36 rounded-xl object-center" source={loginImages.spiderMan}/>
          </View>
